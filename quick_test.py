#!/usr/bin/env python3
"""
Quick Test - Face Recognition Demo
This will capture your face and then recognize you!
"""
...
print("=" * 60)
print("🎥 FACE RECOGNITION - QUICK TEST")
print("=" * 60)
print("\nThis will:")
print("1. Capture your face using webcam")
print("2. Save it as a student")
print("3. Encode it")
print("4. Run face recognition to recognize you!")
print("\n" + "=" * 60)
...
try:
    ...
    print("=" * 60)
    print("Look at the camera - you should see your name!")
    ...
    print("=" * 60)
    print(f"Your face was captured and recognized as: {name}")
